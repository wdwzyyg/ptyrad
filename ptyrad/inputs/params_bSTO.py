...
ptycho_output_path = 'output/bSTO/20240515_full_N50688_dp128_random32_p6_plr1e-4_oalr5e-4_oplr5e-4_slr1e-4_tlr0_1obj_13slice_dz10.0_kzreg1_pmk0.61_continue_L1/model_iter0110.pt'
...
exp_params = {
    ...
    'scan_flipT'        : None, # (0,0,1), # (0,0,1) for 'simu' pos, None for loaded pos. Modify scan_flipT would change the image orientation. Expected input is [flipup, fliplr, transpose] just like PtychoShleves
