...
ptycho_output_path = 'data/20240812_Zeolite_Guanxing/Dataset_2/Niter200.mat'
exp_CBED_path      = 'data/20240812_Zeolite_Guanxing/Dataset_2/data_roi_full_dp.hdf5' 
...
exp_params = {
    ...
    'dx_spec'           : 0.3712,# Ang
    'defocus'           : 130, # Ang, positive defocus here refers to actual underfocus or weaker lens strength following Kirkland/abtem/ptychoshelves convention
...
source_params = {
    ...
    'pos_params'         : None,
    'tilt_source'        : 'simu',
    'tilt_params'        : {'tilt_type':'all', 'init_tilts':[[0,5]]}, # 'init_tilts' = (tilt_y,tilt_x) mrad, 'tilt_type' = 'all', 'each' 
    # 'obj_source'         : 'PtyRAD', 
...
loss_params = {
    ...
    'loss_sparse': {'state': True, 'weight': 0.05, 'ln_order': 1},
...
constraint_params = {
    ...
    'kz_filter'     : {'freq': None,    'obj_type':'both', 'beta':0.3, 'alpha':1},
    'obja_thresh'   : {'freq': 1, 'relax':0, 'thresh':[0.6**(1/56), 1.4**(1/56)]},
